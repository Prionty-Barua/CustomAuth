            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="navbar-brand btn btn-outline-success" href="index.blade.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="navbar-brand btn btn-outline-success" href="#">Report</a>
                        </li>
                        <li class="nav-item">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <ul class="navbar"> 
            <li><a class="nav-link" href="www.facebook.com"><i class="fa-brands fa-facebook-f"></i></a></li>
            </ul>
        </nav>
